# # making minor changes like removing the downloaded json and temp folders after the extraction is done
...
# # ==============================================================================
# # PHASE 3: LANGUAGE DETECTION & VALIDATION
# # ==============================================================================
...
#         return detect_languages(raw_text, llm)                                                            #calling the detect_languages function here to get the language
...
# def detect_languages(raw_text: str, llm: ChatOpenAI) -> list:                                   #actual logic for the language detection                 here i have added as much as langauges possible
#     """Detect languages from raw text using LLM."""
...
#                                                                                                                                    #have added all the languages as valid languages 
#             valid_languages = [
#     # Indian Languages
#     'english', 'hindi', 'marathi', 'gujarati', 'bengali', 'punjabi', 'tamil', 'telugu',
#     'kannada', 'malayalam', 'odia', 'urdu', 'assamese', 'konkani', 'manipuri', 'sanskrit',
#     'bodo', 'santali', 'dogri', 'nepali', 'kashmiri', 'maithili',

#     # East & Southeast Asian
#     'chinese', 'japanese', 'korean', 'thai', 'vietnamese', 'burmese', 'khmer', 'lao', 'mongolian',

#     # Middle Eastern
#     'arabic', 'persian', 'farsi', 'turkish', 'hebrew', 'kurdish', 'pashto', 'uzbek',

#     # European
#     'french', 'german', 'spanish', 'italian', 'portuguese', 'russian', 'ukrainian',
#     'polish', 'romanian', 'greek', 'czech', 'hungarian', 'dutch', 'swedish',
#     'norwegian', 'finnish', 'danish', 'icelandic', 'serbian', 'croatian', 'bosnian',
#     'slovak', 'bulgarian', 'albanian', 'latvian', 'lithuanian', 'estonian',

#     # African
#     'swahili', 'amharic', 'zulu', 'hausa', 'somali', 'yoruba', 'igbo', 'afrikaans',

#     # American & Indigenous
#     'quechua', 'guarani', 'nahuatl', 'mapudungun',

#     # Pacific & Oceanian
#     'maori', 'samoan', 'tongan', 'fijian', 'hawaiian',

#     # Misc
#     'latin', 'esperanto', 'catalan', 'basque', 'galician', 'slovenian'
# ]
...
#                     if lang_clean in valid_languages and lang_clean not in detected_languages:
...
#         print("    [Detection] ✗ No valid languages detected in response")
#         return []
...
# def validate_languages(source_lang: str, target_langs: list, detected_langs: list) -> bool:                                            #in the code we have mentioned that detected_langs are the detected languages from the raw_text
#     """STRICT validation: Check if provided languages match detected languages."""
...
#     print("\n[STEP 5] Detecting and validating languages (STRICT)...")
